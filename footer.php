    ...
    <? } ?>
    <? if(is_page('extra-programaticas') || is_page('galeria-multimedia') || is_page('noticias')) { ?>
...
<script type='text/javascript'>
/* <![CDATA[ */
var ajax = {"url":"http:\/\/www.elbuencamino.info\/csmlc\/wp-admin\/admin-ajax.php"};
/* ]]> */
</script>
<script type='text/javascript' src='http://www.elbuencamino.info/csmlc/wp-content/plugins/ultimate-wp-query-search-filter/classes/scripts/uwpqsfscript.js?ver=1.0'></script>
</body>
